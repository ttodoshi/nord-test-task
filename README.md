...
В задании токен описан "token - строка длиной 32 символа, состоящая только из символов A-Z0-9"

На деле проверяется по регулярному выражению ^[0-9A-F]{32}$ (то есть буквы только A-F, а не A-Z)
